const CACHE='anatomy-quiz-taxonomy-v7';
const CORE=['./','./index.html','./styles.css','./image-styles.css','./shell.js','./compat.js','./goodnotes-parser.js','./figure-session-import.js','./figure-poll.js','./figure-render.js','./taxonomy.js','./app.js','./manifest.webmanifest'];
